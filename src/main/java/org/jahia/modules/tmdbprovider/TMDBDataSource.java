...
public class TMDBDataSource implements ExternalDataSource, ExternalDataSource.LazyProperty, ExternalDataSource.Searchable {
    ...
    private static final String API_CONFIGURATION = "/3/configuration";
    private static final String API_MOVIE = "/3/movie/";
    private static final String API_PERSON = "/3/person/";
    private static final String API_DISCOVER_MOVIE = "/3/discover/movie";
    private static final String API_SEARCH_MOVIE = "/3/search/movie";
    private static final Pattern YEAR_PATTERN = Pattern.compile("[0-9]{4,4}");
    private static final Pattern DATE_PATTERN = Pattern.compile("[0-9]{4,4}/[0-9]{2,2}");
    ...
    private JSONObject queryTMDB(String path, String... params) throws RepositoryException {
        try {
            ...
            url.setQuery(m.keySet().toArray(new String[0]), m.values().toArray(new String[0]));
